...
class ControllerMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'arche:controller';
    ...
    protected function buildParentReplacements()
    {
        ...
        if (!class_exists($parentModelClass)) {
            if ($this->confirm("A {$parentModelClass} model does not exist. Do you want to generate it?", true)) {
                $this->call('arche:model', ['name' => $parentModelClass]);
            }
        }
    ...
    protected function buildModelReplacements(array $replace)
    {
        ...
        if (!class_exists($modelClass)) {
            ...
            $this->call('arche:model', ['name' => $modelClass]);
        }
        ...
        return array_merge($replace, [
            ...
            'dummyModel' => lcfirst(class_basename($modelClass)),
            'dummyModelPlural' => Str::plural(lcfirst(class_basename($modelClass)), 2),
            '$modelSlug$' => $modelSlug,
            '$label$' => $label,
