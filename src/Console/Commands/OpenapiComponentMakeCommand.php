...
class OpenapiComponentMakeCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'arche:openapi:component';
    ...
    protected function getStub()
    {
        if (!$this->option('type') || $this->option('type') == 'store') {
            return config('arche.stubs_dir') . '/openapi.component.stub';
        }
    ...
    protected function buildClass($name)
    {
        ...
        $clean_model = str_replace('App\\OpenAPI\\components\\', '', $name);
        $replace = [
