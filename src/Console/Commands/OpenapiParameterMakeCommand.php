...
class OpenapiParameterMakeCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'arche:openapi:parameter';
    ...
    protected function getStub()
    {
        if (!$this->option('type') || $this->option('type') == 'store') {
            return config('arche.stubs_dir') . '/openapi.parameter.stub';
        }
    ...
    protected function buildClass($name)
    {
        ...
        $clean_model = str_replace('App\\OpenAPI\\parameters\\', '', $name);
        $replace = [
